...
type GrantTypeClientCredentials struct {
	ClientID     string `json:"client_id"`
	ClientSecret string `json:"client_secret"`
	Scope        string `json:"scope"`
}

func GrantClientCredentials(grant *GrantTypeClientCredentials, tokenEndpoint string) (string, error) {
	...
	data := url.Values{}
	data.Set("grant_type", GRANT_TYPE_CLIENT_CREDENTIALS)
